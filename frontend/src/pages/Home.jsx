...
const architectureCards = [
  { icon: Code2, eyebrow: "Frontend", title: "A deliberate React surface", body: "React, JavaScript, Vite, Tailwind, Router, and reusable UI primitives keep every screen composable and testable.", accent: "cyan" },
...
export default function Home() {
  ...
  const [theme, setTheme] = useState(() => {
    ...
    return localStorage.getItem("clinical-atlas-theme") || "dark";
  });
